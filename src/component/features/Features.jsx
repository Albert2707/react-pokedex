  ...
  return (
    <div className="fixed  bg-[#222]/50 inset-0 z-50 pt-5">
      <div className="flex flex-col gap-5 items-center justify-center bg-white dark:bg-[#1b1c1e]  absolute inset-0 w-[90%] sm:w-[80%] md:w-[50%] lg:w-1/2 xl:w-[30%] px-24  h-min m-auto py-14 rounded-xl ">
        <img
          className="absolute z-10 inset-0 -top-32 md:-top-48 mx-auto h-40 md:h-60   object-cover"
        ...
        <div className="w-full flex flex-col gap-5">
          <span className="text-lg sm:text-xl  font-medium">
            ...
            <span className="text-lg sm:text-xl md:text-2xl">
              Name:
            </span> &nbsp; {onePokemon.name}
          </span>
          <p className="flex text-base sm:text-xl  text-center items-center">
            {" "}
            <span className="text-lg hidden md:block  md:text-2xl font-medium items-center ">
              Habilidad1: &nbsp;{" "}
            </span>{" "}
            {onePokemon.abilities[0].ability.name}
          </p>
        </div>
